const popularRecipes = [
    ...
    {
        id: 0,
        img: "img/main/popular-recipes/previews/Mixed-fruits-460x295.jpg",
    ...
    {
        id: 1,
        img: "img/main/popular-recipes/previews/r-rachel-park-366508-unsplash-min-460x295.jpg",
    ...
    {
        id: 2,
        img: "img/main/popular-recipes/previews/r-michelle-tsang-500721-unsplash-min-460x295.jpg",
        title: "Morbi porttitor convallis leo. Donec a nisl lacinia",
    ...
    {
        id: 3,
        img: "img/main/popular-recipes/previews/quick-summer-drink-460x295.jpg",
        title: "Etiam vitae libero sodales velit egestas mollis. Vestibulum",
    ...
    {
        id: 4,
        img: "img/main/popular-recipes/previews/r-maarten-van-den-heuvel-400626-unsplash-min-460x295.jpg",
    ...
    {
        id: 5,
        img: "img/main/popular-recipes/previews/perfect-cosmopolitan-460x295.jpg",
    ...
    {
        id: 6,
        img: "img/main/popular-recipes/previews/fi2x-6-460x295.jpg",
    ...
    {
        id: 7,
        img: "img/main/popular-recipes/previews/r-brooke-lark-96398-unsplash-min-460x295.jpg",
